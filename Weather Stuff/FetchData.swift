...
//  Kuai
//
//  Created by Michael Liu (student LM) on 3/13/23.
//
...
class FetchData: ObservableObject {
    ...
    func getData() async {
        let URLString = "https://api.weatherapi.com/v1/forecast.json?key=30162b6f7d694ddaac1170346231201&q=19004&days=7&aqi=no&alerts=no"
...
struct Location: Codable {
    ...
    var region: String = "Default Place"
}
